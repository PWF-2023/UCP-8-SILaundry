                                ...
                                <tr class="odd:bg-white odd:dark:bg-gray-800 even:bg-gray-50 even:dark:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <p>{{ $user->transactions->count() }}
                                            <span>
                                                <span
                                                    class="text-green-600 dark:text-green-400">({{ $user->transactions->where('is_complete', true)->count() }}</span>/
                                                <span
                                                    class="text-blue-600 dark:text-blue-400">{{ $user->transactions->where('is_complete', false)->count() }})</span>
                                            </span>
                                        </p>
                                    </td>
                                    {{-- <td class="px-6 py-4 whitespace-nowrap">
